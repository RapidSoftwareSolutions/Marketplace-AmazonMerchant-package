...
| LabelFormat | The seller's preferred label format. | No | Must match one of the AvailableLabelFormats returned by [GetEligibleShippingServices](MerchFulfill_GetEligibleShippingServices.html "Returns a list of shipping service offers."). Type: string |